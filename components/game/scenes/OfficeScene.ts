...
export class OfficeScene extends Phaser.Scene {
  ...
  preload() {
    // office3 is generated from lib/map/office.ts — see scripts/build-map.ts.
    // Point this back at office2.json to get the old partitioned office.
    this.load.tilemapTiledJSON("office", "/maps/office3.json");
  ...
  create() {
    ...
    // Out through the door is the world map; the lift goes nowhere yet.
